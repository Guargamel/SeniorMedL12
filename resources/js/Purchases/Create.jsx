// resources/js/Purchases/Create.jsx
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        setForm((f) => ({
          ...f,
          category: f.category || (cList[0]?.id ? String(cList[0].id) : ""),
          supplier: f.supplier || (sList[0]?.id ? String(sList[0].id) : ""),
        }));
      } catch (e) {
        if (alive) setErr(e.message || "Failed to load form data");
      } finally {
